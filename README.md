> Release 0.2.117 adds 4 Bars to Quant Grid, Chord Grid, Follower Buffer, Lookahead, Arp Rate and Strum, plus -4 Bars for lookahead. Existing defaults and saved option IDs are preserved. Compatible with Movy hbclean.32.
...
HarmonyBus **0.2.117** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.117-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.117)
