> Release 0.2.109 restores conductor chord generation, rendered-chord recording and quality controls. Pair with Movy hbclean.31 for recording. Arp phase remains available; the experimental UI Test page is removed.
...
HarmonyBus **0.2.109** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.109-module.tar.gz`.
