> Release 0.2.122 makes Repeat Arp bypass Follower Buffer for note presses and releases. Arp Rate and Phase control timing, while conductor-first processing and held-note reharmonization remain intact. Compatible with Movy hbclean.35.
...
HarmonyBus **0.2.122** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.122-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.122)
