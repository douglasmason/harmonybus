> Release 0.2.127 keeps latched arp hits steady during rapid input: replacing the note pool preserves the clock and completes the current hit. Movy hbclean.40 remains compatible.
...
HarmonyBus **0.2.127** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.127-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.127)
