> Release 0.2.119 makes held Conductor Chord followers respond to harmony changes when Retrigger Held is On, including latched chords, arps and strums. Off preserves the original gesture; enabling On catches an existing held chord up to the current harmony. Compatible with Movy hbclean.35.
...
HarmonyBus **0.2.119** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.119-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.119)
