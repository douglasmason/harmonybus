> Release 0.2.116 integrates Conductor / Follower / Receiver / Off into the main Role selector, places Receive Channel after Render To Ch, and moves Accidentals to Global. Compatible with Movy hbclean.32.
...
HarmonyBus **0.2.116** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.116-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.116)
