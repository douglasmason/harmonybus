> Release 0.2.115 adds the Receiver role: select Receive Channel 1–16 to play existing HB render output through a local instrument. Original stock Move/Schwung MIDI broadcasts remain intact. Movy hbclean.32 prepares tracks 13–16 as receivers on channels 1–4, without instruments.
...
HarmonyBus **0.2.115** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.115-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.115)
