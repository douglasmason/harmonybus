> Release 0.2.128 exposes a read-only current/effective harmony snapshot for Movy hbclean.41 pad colors. Retains the latched arp timing fix from 0.2.127.
...
HarmonyBus **0.2.128** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.128-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.128)
