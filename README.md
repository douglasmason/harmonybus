> Release 0.2.114 shortens musical Follower Buffer windows by 1 ms at their leading edge, protecting quantized notes at the nominal edge. Lookahead adds signed 3/8, 3/4, 1.5 Bars, 2 Bars and 3 Bars choices. Millisecond buffers and grid targets keep their exact values. Compatible with Movy hbclean.31.
...
HarmonyBus **0.2.114** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.114-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.114)
