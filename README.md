> Release 0.2.125 adds the eight-knob Foll Play panel: tone rotation, octave wrapping, mirror, octave shift, 1–4 octave arp range, clip/live scope, bypass and reset. Pair with Movy hbclean.40 for prioritized touch release.
...
HarmonyBus **0.2.125** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.125-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.125)
