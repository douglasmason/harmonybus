> Release 0.2.110 fixes generated-chord detection across F-Dm-G-Em and renames Scale Root to Scale Degree. Use Chromatic Below on Foll Mod for diminished leading-tone chords; the duplicate Auto Chord button is removed. Compatible with Movy hbclean.31.
...
HarmonyBus **0.2.110** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.110-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.110)
