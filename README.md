> Release 0.2.113 adds Closest Split 2 chromatic approach pads and a Master Transpose knob with named destination roots. Compatible with Movy hbclean.31.
...
HarmonyBus **0.2.113** makes Follower Buffer global with a **1/16-note** default for
...
The output is `dist/harmonybus-v0.2.113-module.tar.gz`.
...
### Auto Chord and Arp / Strum (0.2.113)
