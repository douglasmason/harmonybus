/* Harmony Bus v0.2.17 — Schwung MIDI FX. */
#define HB_VERSION "0.2.17"
...
static void hb_restore_state(Inst *instance,const char *state){
    ...
    if((is_hb10||is_hb9)&&values[0]==0&&!instance->global_timing_restored){
    ...
    }else if(!is_hb10&&!is_hb9&&parsed>=15&&values[0]==0&&!instance->global_timing_restored){
...
if(!strcmp(key,"v87_marker"))return snprintf(buffer,(size_t)length,"%s","HB217");
