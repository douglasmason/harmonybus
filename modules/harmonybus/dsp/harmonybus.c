/* Harmony Bus v0.2.37 — Schwung MIDI FX. */
#define HB_VERSION "0.2.37"
...
static int hb_map_scale_degree_relative(Inst *instance,int source_note,hb_harmony_t harmony){
    ...
    /* In Scale collapses chromatic variants onto scale-function buckets:
       b2/2 => 2/9, m3/M3 => 3, 4/#4 => 4/11, b6/6 => 6/13,
       m7/M7 => 7. The TARGET accidental is supplied by the chord-scale. */
...
if(!strcmp(key,"v87_marker"))return snprintf(buffer,(size_t)length,"%s","HB237");
