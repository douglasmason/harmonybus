...
"{\\\"key\\\":\\\"travel_map\\\",\\\"name\\\":\\\"Follower Travel\\\",\\\"type\\\":\\\"enum\\\",\\\"options\\\":[\\\"Relative\\\",\\\"Closest\\\"],\\\"options_as_string\\\":true,\\\"default\\\":\\\"Relative\\\"},"
...
if(!strcmp(key,"v87_marker"))return snprintf(buffer,(size_t)length,"%s","HB226");
