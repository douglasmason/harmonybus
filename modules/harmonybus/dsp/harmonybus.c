/* Harmony Bus v0.2.20 — Schwung MIDI FX. */
#define HB_VERSION "0.2.20"
...
static void hb_restore_state(Inst *instance,const char *state){
    ...
    if((is_hb13||is_hb12||is_hb11||is_hb10||is_hb9)&&values[0]==0&&!instance->global_timing_restored){
        ...
        if((is_hb13||is_hb12||is_hb11||is_hb10)&&values[19]>=0&&values[19]<=100)g_bus.boundary_buffer_ms=values[19];
...
if(!strcmp(key,"v87_marker"))return snprintf(buffer,(size_t)length,"%s","HB220");
