...
static int hb_observed_notes(const Inst *instance,uint8_t *output,int max_notes){
    ...
    if((instance->source_mode==0||instance->source_mode==2)&&g_bus.clip_valid){
    ...
    if(instance->source_mode==1||instance->source_mode==2){
