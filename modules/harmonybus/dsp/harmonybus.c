/* Harmony Bus v0.1.94 — Schwung MIDI FX. */
#define HB_VERSION "0.1.94"
...
if(!strcmp(key,"v87_marker"))return snprintf(buffer,(size_t)length,"%s","HB194");
