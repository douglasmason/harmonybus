/* Harmony Bus v0.2.11 — Schwung MIDI FX. */
#define HB_VERSION "0.2.11"
...
static int hb_find_conductor_track(const char *uuid){
    ...
    for(int track=0;track<4;track++){
        ...
        int is_conductor=(strstr(json,"hb8,0,")||strstr(json,"hb7,0,")||strstr(json,"hb6,0,")||strstr(json,"hb5,0,")||strstr(json,"hb4,0,")||strstr(json,"hb3,0,")||strstr(json,"hb2,0,")||strstr(json,"hb1,0,"));
        free(json);
...
if(!strcmp(key,"v87_marker"))return snprintf(buffer,(size_t)length,"%s","HB211");
