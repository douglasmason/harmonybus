...
static const char *hb_pc_display(int pc,hb_harmony_t context){
    ...
    int use_flats=g_bus.accidentals==1||(g_bus.accidentals==0&&hb_auto_prefers_flats(context));
    pc%=12;if(pc<0)pc+=12;return use_flats?flat[pc]:sharp[pc];
}
