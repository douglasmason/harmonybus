/* Harmony Bus v0.2.43 — Schwung MIDI FX. */
#define HB_VERSION "0.2.43"
...
if(!strcmp(key,"v87_marker"))return snprintf(buffer,(size_t)length,"%s","HB243");
